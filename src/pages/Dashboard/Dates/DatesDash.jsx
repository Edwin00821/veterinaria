        ...
        <div className='flex h-screen w-screen'>
          <div className='flex h-full w-full items-center'>
            <div className='h-6/7 w-full'>
              <div className='h-1/7 text-green flex items-center justify-center text-3xl font-semibold'>
                DashBoard
              </div>
              <div className='first-letter:| h-[85%] w-[100%] overflow-y-scroll bg-[#fff] pl-[1vw]'>
                <ContainerTwoGraph
                  Grahp1={
                    Graph1 ? (
                      <DataEstadistic
