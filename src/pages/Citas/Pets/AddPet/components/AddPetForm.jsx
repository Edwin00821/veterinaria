...
import { Select, Input, Dropzone } from '@/components'
...
const AddPetForm = () => {
  ...
  return (
    ...
    >
      <Dropzone
        className='relative grid h-[250px] w-[180px] place-items-center rounded-[100%] border-4 border-primary'
        name='urlFoto_mas'
        value={watch('urlFoto_mas')}
        setValue={setValue}
        errors={errors.urlFoto_mas}
      />
